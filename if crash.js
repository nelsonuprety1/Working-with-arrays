...
const displayMovements = function (movements, sort = false) {
  // overwriting the default values. emptying the entire container
  ...
  movs.forEach(function (mov, i) {
    ...
    // template literals are amazing to create html template like below
    // we are creating a sting of HTML
    const html = `
    ...
    // Inserting  that string of HTML with insertAdjacentHTML() method
...
const createUsernames = function (accs) {
  accs.forEach(function (acc) {
    // creating a new property on the account element and that will then contain username
...
btnTransfer.addEventListener("click", function (e) {
  // if we didnt dopreventdefault it will reload the page
  e.preventDefault();
